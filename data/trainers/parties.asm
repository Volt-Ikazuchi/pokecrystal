...
FalknerGroup:
	...
	db 11, HOOTHOOT,   TACKLE, MUD_SLAP, CONFUSION, HYPNOSIS
	db 12, PIDGEY,     QUICK_ATTACK, MUD_SLAP, GUST, SAND_ATTACK
	db 13, PIDGEOTTO,  QUICK_ATTACK, MUD_SLAP, GUST, PURSUIT
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, TEDDIURSA,  HEADBUTT, ATTRACT, LICK, CUT
	db 18, CLEFAIRY,   HEADBUTT, CONFUSION, ENCORE, METRONOME
...
BugsyGroup:
	...
	db 14, LEDYBA,     TACKLE, SUPERSONIC, COMET_PUNCH, THUNDERPUNCH
	db 14, BUTTERFREE, CONFUSION, LEECH_LIFE, POISONPOWDER, HIDDEN_POWER
...
MortyGroup:
	...
	db 21, GASTLY,     THIEF, SPITE, MEAN_LOOK, CURSE
	db 22, STANTLER,   HYPNOSIS, HEADBUTT, SHADOW_BALL, NIGHTMARE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER,    CONFUSE_RAY, MEAN_LOOK, FRUSTRATION, SHADOW_BALL
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 34, SNEASEL,    BLIZZARD, ICY_WIND, PURSUIT, STRENGTH
	db 35, JYNX,       RAIN_DANCE, PSYCHIC, LOVELY_KISS, ICE_BEAM
	db 35, DEWGONG,    RAIN_DANCE, ICY_WIND, SURF, WATERFALL
	db 38, PILOSWINE,  ICY_WIND, ROCK_CLIMB, EARTHQUAKE, BLIZZARD
	db 38, LAPRAS,     RAIN_DANCE, ICY_WIND, SURF, BODY_SLAM
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 33, SKARMORY,   SPIKES, STEEL_WING, SAND_ATTACK, WHIRLWIND
	db 32, WARTORTLE,   SURF, IRON_TAIL, REST, SLEEP_TALK
	db 33, MAGNETON,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 34, SCIZOR,   SONICBOOM, FURY_CUTTER, PURSUIT, HEADBUTT
	db 35, STEELIX,    DIG, ROAR, CURSE, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 28, HITMONTOP,  DYNAMICPUNCH, REVERSAL, QUICK_ATTACK, COUNTER
	db 28, PRIMEAPE,   PURSUIT, LOW_KICK, MEGA_PUNCH, FRUSTRATION
	db 28, HITMONLEE,  JUMP_KICK, ROLLING_KICK, STRENGTH, LOW_KICK
	db 28, HITMONCHAN, MACH_PUNCH, MEGA_PUNCH, THUNDERPUNCH, ICE_PUNCH
	db 31, POLIWRATH,  HYPNOSIS, ICE_PUNCH, SURF, MEGA_PUNCH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, SEADRA,     TWISTER, WATERFALL, SURF, DRAGONBREATH
	db 37, DRAGONAIR,  SURF, THUNDERBOLT, ICE_BEAM, DRAGONBREATH
	db 37, DRAGONAIR,  REFLECT, SAFEGUARD, LIGHT_SCREEN, DRAGONBREATH
	db 40, CHARIZARD,  FLAMETHROWER, EARTHQUAKE, HYPER_BEAM, DRAGONBREATH
...
Rival1Group:
	...
	db 21, SNEASEL,    LEER, QUICK_ATTACK, ICE_PUNCH, PURSUIT
	...
	db 20, GOLBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 21, SNEASEL,    LEER, QUICK_ATTACK, ICE_PUNCH, PURSUIT
	db 22, QUILAVA,    LEER, SMOKESCREEN, FLARE, QUICK_ATTACK
	db -1 ; end
	...
	db 20, GOLBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 21, SNEASEL,    LEER, QUICK_ATTACK, ICE_PUNCH, PURSUIT
	db 22, CROCONAW,   LEER, RAGE, WATERFALL, BITE
	db -1 ; end

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 32, SNEASEL,    ICE_PUNCH, QUICK_ATTACK, BEAT_UP, NIGHT_SHADE
	...
	db 32, MEGANIUM,   REFLECT, GIGA_DRAIN, LEECH_SEED, BODY_SLAM
	db -1 ; end
	...
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, QUILAVA,    DIG, FLARE, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, FERALIGATR, ICE_PUNCH, SURF, BITE, SCARY_FACE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 34, SNEASEL,    FRUSTRATION, ICE_BEAM, NIGHT_SHADE, FURY_CUTTER
	db 36, CROBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 35, MAGNETON,   THUNDERBOLT, SONICBOOM, THUNDER_WAVE, SWIFT
	db 35, GENGAR,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, ALAKAZAM,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, MEGANIUM,   REFLECT, GIGA_DRAIN, LEECH_SEED, BODY_SLAM
	db -1 ; end
	...
	db 35, GENGAR,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, ALAKAZAM,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, TYPHLOSION, THUNDERPUNCH, FLARE, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 34, SNEASEL,    FRUSTRATION, ICE_BEAM, NIGHT_SHADE, FURY_CUTTER
	db 36, CROBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   THUNDERBOLT, SONICBOOM, THUNDER_WAVE, SWIFT
	db 35, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, ALAKAZAM,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FERALIGATR, ICE_PUNCH, SURF, CRUNCH, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 45, XATU,       FLY, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 45, JYNX,       PSYCH_UP, LOVELY_KISS, ICE_BEAM, PSYCHIC_M
	db 45, EXEGGUTOR,  REFLECT, LEECH_SEED, GIGA_DRAIN, PSYCHIC_M
	db 45, CLEFABLE,   CURSE, MOONLIGHT, BODY_SLAM, PSYCHIC_M
	db 45, SLOWKING,   SURF, FLAMETHROWER, RECOVER, PSYCHIC_M
	db 46, XATU,       DRILL_PECK, SHADOW_BALL, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 47, PRIMEAPE,   CROSS_CHOP, BEAT_UP, PURSUIT, ROCK_SLIDE
	db 47, HITMONTOP,  TRIPLE_KICK, MEGAHORN, DIG, ROCK_SLIDE
	db 47, HITMONLEE,  HYPER_BEAM, LOW_KICK, HI_JUMP_KICK, FORESIGHT
	db 47, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, MEGA_PUNCH, MACH_PUNCH
	db 47, ELECTABUZZ, THUNDERBOLT, CROSS_CHOP, ICE_PUNCH, THUNDER_WAVE
	db 48, MACHAMP,    ROCK_SLIDE, EARTHQUAKE, MACH_PUNCH, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 47, PERSIAN,    HYPER_BEAM, CRUNCH, ROAR, THUNDER_WAVE
	db 48, UMBREON,    PSYCH_UP, BATON_PASS, NIGHT_SHADE, MOONLIGHT
	db 48, GENGAR,     NIGHT_SHADE, THUNDERBOLT, HYPNOSIS, DESTINY_BOND
	db 48, CROBAT,     NIGHT_SHADE, TWISTER, GIGA_DRAIN, CONFUSE_RAY
	db 48, HOUNDOOM,   ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db 50, TYRANITAR,  ROCK_SLIDE, EARTHQUAKE, FIRE_BLAST, CRUNCH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 46, FORRETRESS, SPIKES, SCREECH, EXPLOSION, CURSE
	db 46, ARIADOS,    MEGAHORN, SPIDER_WEB, BATON_PASS, SLUDGE_BOMB
	db 46, VILEPLUME,  GIGA_DRAIN, TOXIC, LEECH_SEED, SUBSTITUTE
	db 46, MUK,        FIRE_BLAST, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 46, NIDOQUEEN,  LOVELY_KISS, EARTHQUAKE, SLUDGE_BOMB, SHADOW_BALL
	db 47, ARBOK,      DISABLE, SLUDGE_BOMB, DESTINY_BOND, CRUNCH
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 50, DRAGONITE,  THUNDER_WAVE, SAFEGUARD, LIGHT_SCREEN, THUNDER
	db 50, CHARIZARD,  FLAMETHROWER, DRAGONBREATH, EARTHQUAKE, CRUNCH
	db 50, KINGDRA,    HYDRO_PUMP, DRAGONBREATH, ICE_BEAM, WHIRLPOOL
	db 50, DRAGONITE,  DRAGONBREATH, TWISTER, ICE_BEAM, THUNDERBOLT
	db 50, CHARIZARD,  FIRE_BLAST, OUTRAGE, EARTHQUAKE, DRAGONBREATH
	db 50, DRAGONITE,  FIRE_BLAST, TWISTER, OUTRAGE, EXTREMESPEED
	db -1 ; end
...
BrockGroup:
	...
	db 41, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, DRILL_RUN
...
CooltrainerMGroup:
	...
	db 26, CHARMANDER, FLARE, SMOKESCREEN, RAGE, SCARY_FACE
	...
	db 27, CHARMELEON, FLARE, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, NINETALES,  FLARE, QUICK_ATTACK, CONFUSE_RAY, SAFEGUARD
	db -1 ; end
...
BurglarGroup:
	...
	db 26, GROWLITHE,  ROAR, FLARE, LEER, TAKE_DOWN
...
ExecutiveMGroup:
	...
	db 33, HOUNDOUR,   FLARE, ROAR, BITE, FAINT_ATTACK
	db 33, KOFFING,    TACKLE, SLUDGE, SMOKESCREEN, HAZE
	db 35, HOUNDOOM,   FLARE, SMOG, BITE, FAINT_ATTACK
	db -1 ; end
